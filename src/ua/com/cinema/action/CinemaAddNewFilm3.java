...
public class CinemaAddNewFilm3 {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					cinemaAddNewFilm3.frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private Integer startH3;
	 ...
	 private JTextField textFieldStartTime3Mm;
		...
		public CinemaAddNewFilm3() {
			...
			JLabel labelInfo = new JLabel("Ви вибрали кількість сеансів : 3");
			...
			btnSubmit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try{
						...
						+ startTime1.toString()+"', '"+startTime2.toString() +"' та "+startTime3.toString() + "' додано до розкладу!\n"
			...
			btnSubmit.setBounds(88, 129, 156, 25);
			...
			lblNewLabel_1.setBounds(208, 75, 42, 14);
			contentPane.add(lblNewLabel_1);
			
			label_3 = new JLabel("   хв");
			label_3.setBounds(272, 75, 31, 14);
			contentPane.add(label_3);
			
			JLabel lblTimeStart3 = new JLabel("Введіть час початку сеансу 3:");
			lblTimeStart3.setBounds(10, 98, 175, 14);
			contentPane.add(lblTimeStart3);
			
			textFieldStartTime3HH = new JTextField();
			textFieldStartTime3HH.setBounds(184, 98, 26, 20);
			contentPane.add(textFieldStartTime3HH);
			textFieldStartTime3HH.setColumns(10);
			
			textFieldStartTime3Mm = new JTextField();
			textFieldStartTime3Mm.setBounds(244, 95, 31, 20);
			contentPane.add(textFieldStartTime3Mm);
			textFieldStartTime3Mm.setColumns(10);
			
			JLabel label_2 = new JLabel("  год :");
			label_2.setBounds(208, 100, 42, 14);
			contentPane.add(label_2);
			
			JLabel label_4 = new JLabel("   хв");
			label_4.setBounds(272, 100, 31, 14);
